...
{
    public class ExecutionPlanParsingTests
    {
        #region SqlServerTests
        [Fact]
        public async Task DatabaseExecutor_Should_Parse_ExecutionPlan_For_SqlServer()
        {
...
GROUP BY ProductName";
            ...
            Assert.NotNull(parsedPlanModel);
        }
        #endregion

        #region PostgreSqlTests
        [Fact]
        public async Task DatabaseExecutor_Should_Parse_ExecutionPlan_For_PostgreSql()
        {
...
inner join orders as ord on ordit.order_id = ord.order_id";
        ...
        [Fact]
        public async Task DatabaseExecutor_Should_Parse_ExecutionPlan_For_Oracle()
        {
